...
namespace AppOwnsDataAdmin.Controllers {
  ...
  public class HomeController : Controller {
    ...
    public HomeController(PowerBiServiceApi powerBiServiceApi, AppOwnsDataDBService AppOwnsDataDBService, B2CAccountsManager b2cAccountsManager) {
    ...
    public IActionResult B2CUserAccounts() {
      var model = this.b2cAccountsManager.GetUsers();
      return View(model);
    }

    public ActionResult B2CUserAccount(string userId) {
      var user = this.b2cAccountsManager.GetUser(userId);
      return View(user);
    }

    public ActionResult DeleteB2CUserAccount(string userId) {
      this.b2cAccountsManager.DeleteUser(userId);
      return RedirectToAction("B2CUserAccounts");
    }

    public ActionResult ToggleB2CUserAccount(string userId) {
      this.b2cAccountsManager.ToggleUserEnabled(userId);
      return RedirectToAction("B2CUserAccount", new { userId=userId });
    }
