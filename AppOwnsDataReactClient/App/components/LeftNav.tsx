...
const LeftNav = () => {
  ...
  const isNotDeleteMyAccountPage: boolean = (location.pathname.toLowerCase().indexOf("deletemyaccount") === -1)
  ...
  return (
    <Drawer variant='permanent' anchor='left'
      sx={{
        ...
        display: (isAuthenticated && embeddingData.tenantName && !embeddingData.workspaceArtifactsLoading && isNotDeleteMyAccountPage) ? "flex" : "none"
      }}
